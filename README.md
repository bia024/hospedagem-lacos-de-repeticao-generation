...
- **CSS3**: Estilização com tema escuro (Dark Mode) inspirado no GitHub, responsividade e layout flexbox.
- **JavaScript (Vanilla)**: Lógica da aplicação, manipulação do DOM e simulação do terminal.
...
1.  **Laço de Repetição For**: Iteração com intervalos e verificação de múltiplos.
2.  **Laço de Repetição While**: Validação de entrada e contadores condicionais.
3.  **Laço de Repetição Do While**: Soma acumulativa com condição de parada.
...
3.  No menu lateral "Explorer", clique em um dos exercícios.
4.  Analise o código exibido e clique no botão **Executar**.
5.  Interaja com o terminal enviando os dados solicitados.

---
Desenvolvido com 💙 por **Bianca Caetano** - Desenvolvedora Frontend Pleno.
